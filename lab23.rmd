...
**Answer**: The mean number of arrests did not result in arrest; 17% resulted in arrest. 
...
**Answer**: 27.5% of the crimes were theft. 
...
**Answer**: Total number of thefts in the dataset.
...
**Answer**: These can be compared because they are means, which are averages. 
...
**Answer**: This value is almost 0.1 larger than that of the entire dataset and can be compared because they are means, which are averages. 
...
**Answer**: It is slightly larger, but they can't be compared because they are sums. 
...
**Answer**: The general pattern is that the theft rate appears to be relatively consistent across all median incomes as for the most part it is below 100. There are 2 outliers above 100 on the theft rate scale, one of which has a median income of just under 20k and the other is just under 30k. The biggest outlier is Loop, it has a really high income but also really high theft rate. 
...
**Answer**: It is the central business district of Chicago, aka the downtown area. The high rate is because the Loop doesn't have a lot of households, and the majority of crimes occur in the public like restaurants, music venues, etc. 
