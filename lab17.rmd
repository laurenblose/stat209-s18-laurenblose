...
**Answer**: The 30th percentile is 34.5, which means that about 30% of cereals did not score higher than 34.5 
...
**Answer**: The healthiest brand is Nabisco.
...
**Answer**: As the number of reviews increases, the score tends to increase.
...
**Answer**: The 80th percentile is 30.00, which is in cents. This indicates taht 80% of the teas cost less than 30.00 cents. 
...
**Answer**: They don't have a lot of reviews. 
...
**Answer**: The variation is smaller. 
...
**Answer**: The masters tea is very interesting because it is so far away from the rest of the points. It's on the entirely opposite side of the graph. It tends to be very highly priced, but also tends to have a high score.
