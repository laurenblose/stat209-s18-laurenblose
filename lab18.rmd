...
**Answer**: Yes they compare very closely. 
...
**Answer**: I would say no based on the large number of salaries on the right side of maximum of that range.
...
It has a similar minimum value and the maximum value is slightly more than that in question 5. 
...
**Answer**: This is a guess for where the true mean lies in the data, so it indicates the absolute minimum and maximum value for what we are looking for. Our best guess estimate should be within this range.   
