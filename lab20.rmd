...
**Answer**: That the difference between the cost of 1 carat and 2 carats is 7756, and to figure out the cost of 0.5 carats you would divide 7756 by 2 and calculate using y = mx + b, 
...
**Answer**: Yes because it is much lower than the lowest value of 7729.

Would you be surprised if we collected another set of diamonds, in exactly the
same way as before, and found a slope estimate equal to 7500?

**Answer**: Not really because it is not much lower than the lowest value of 7729.
...
**Answer**: It is statistically significant because both values are positive. The 7756 indicates the difference in price from 1 carat to 2. 
...
**Answer**: Intercept - slope x 60

Describe in words the estimate of the slope in terms of the dataset.

**Answer**: The slope is -29.65 which means that as depth lowers, price decreases.
...
**Answer**: The intercept values are both positive and the depth values are both negative.

Interpret this in words (your words, not just the formal definition).

**Answer**: This means that both are statistically signficiant because neither has a positive and negative value. 
...
**Answer**: Intercept + depthx50 + caratx2

Are both of the slopes in the model statistically significant? What are
their signs?

**Answer**: Both are statistically significant because they both have the same sign that their category has. Depth has a negaive and carat has a positive.
...
**Answer**: The slope of carats indicates that price increases as carats increases, and the slope of depth indicates that the price decreases as depth decreases. 
...
**Answer**: (Intercept + depth + caratx2) - (Intercept + depth +caratx1)
