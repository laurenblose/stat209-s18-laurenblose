...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  xlab("Male Mass") +
  ylab("Egg Mass") +
  ggtitle("Male Bird Mass vs Egg Mass in Grams")
```

How would you now describe the relationship between the two variables (I just need one sentence here)?

Answer: The relationship between the two variables is that as the mass of the male bird increases, the mass of the egg increases as well. 
...
```{r}
parrots <- filter(birds, type %in% c("Parrot"))
parrots
```
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  annotate("rect", xmin = 40, xmax = 250,
                   ymin = 3.5, ymax = 15,
                   fill = "purple", alpha = 0.15) +
  annotate("text", x = 300, y = 5, size = 3.5,
           label = "Red Points Indicate Parrots") +
  scale_x_log10() +
  scale_y_log10() +
  xlab("Male Mass") +
  ylab("Egg Mass") +
...
Answer: Yes, as described in my first response and demonstrated by the line of best-fit, as the mass of male birds increases, the mass of the egg increases as well.
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  annotate("rect", xmin = 200, xmax = 250,
                   ymin = 80, ymax = 100,
                   fill = "purple", alpha = 0.15) +
  annotate("text", x = 250, y = 125, size = 5.5,
...
```{r}
small_birds <- filter(birds, male_mass < 15)
small_birds
```
...
ggplot(birds, aes(male_mass, egg_mass)) +
  geom_point() +
  geom_point(color ="red", data = small_birds) + 
  scale_x_log10() +
  scale_y_log10() +
  xlab("Male Mass") +
  ylab("Egg Mass") +
  ggtitle("Male Bird Mass vs Egg Mass of Birds in Grams") +
 geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5) +
  annotate("rect", xmin = 0, xmax = 3.75,
                   ymin = 0, ymax = 0.75,
                   fill = "purple", alpha = 0.15) +
  annotate("text", x = 8, y = 0.3, size = 3.5,
           label = "Ruby-Throated Hummingbird") 
```
This graph displays the mass of male birds compared to the mass of their eggs in grams. The red points indicate male birds with a mass less than 15 grams. The Ruby-Throated Hummingbird is the smallest bird in this dataset and is indicated in the graph. 
